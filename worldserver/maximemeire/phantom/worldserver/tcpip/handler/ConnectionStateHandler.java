...
import maximemeire.phantom.model.entity.player.PlayerMessageDispatcher;
...
public class ConnectionStateHandler extends SimpleChannelHandler {
	...
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) {
		...
		Player player = new Player(ctx.getChannel(), PLCodec317.getCodec());
		worldUniverse.setupActor(player, new PlayerMessageDispatcher<Player>(player));
